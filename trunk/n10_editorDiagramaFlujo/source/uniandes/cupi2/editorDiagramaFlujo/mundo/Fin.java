/**
 * ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
 * $Id: Fin.java,v 1.4 2009/10/21 15:57:50 carl-veg Exp $
...
/**
 * Clase que representa un elemento de finalización en un diagrama de flujo
 */
public class Fin extends FormaBasica
{
    // -----------------------------------------------------------------
    // Constantes
    // -----------------------------------------------------------------
     ...
     */
    public final static String TIPO = "FIN";
    
    /**
     * Representa texto de la forma
     */
    public final static String TEXTO = "Fin";
    ...
    /**
     * Constructor de un elemento de finalización en un diagrama de flujo
     * @param punto Punto donde se desea construir el elemento
     */
    public Fin( Punto punto )
    {
        super( punto, new Punto( punto.darX( ) + ANCHO, punto.darY( ) + ALTO ) );
    }

    /**
     * Crea una forma de fin a partir de los datos contenidos en un archivo.
     ...
     */
    public Fin( BufferedReader br ) throws IOException, FormatoInvalidoException
    {
        super( br );
    }
    ...
    /**
     * Pinta una forma de fin en el lienzo
