...
/**
 * Clase que representa un elemento de salida de información en un diagrama de flujo
 */
public class SalidaInformacion extends FormaBasica
{
    ...
    /**
     * Constructor de un elemento de salida de información en diagrama de flujo
    ...
    /**
     * Crea un un elemento de salida de información a partir de los datos contenidos en un archivo.
