...
/**
 * Esta es la clase usada para verificar que los métodos de la clase Decision estén correctamente implementados
 */
public class DecisionTest extends TestCase
{
    ...
    {
        setupEscenario1( );
        assertTrue( "Construcción incorrecta.", elemento.darAlto( ) == Decision.ALTO );
        assertTrue( "Construcción incorrecta.", elemento.darAncho( ) == Decision.ANCHO);
        assertTrue( "Construcción incorrecta.", elemento.darTipo( ).equals( Decision.TIPO ) );
    }
    ...
    public void testAsignarDarTexto( )
    {
        ...
        assertTrue( "Cambio y/o asignación de texto incorrecto.", elemento.darTexto( ).equals( "Decision 1" ) );
    }
    ...
    {
        setupEscenario1( );
        assertTrue( "Cálculo de altura incorrecto", elemento.darAlto( ) == Decision.ALTO );
    }
    ...
    {
        setupEscenario1( );
        assertTrue( "Cálculo de altura incorrecto", elemento.darAncho( ) == Decision.ANCHO );
    }
